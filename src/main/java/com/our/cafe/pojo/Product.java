...
@NamedQuery(name = "Product.getAllProducts", query = "select new com.our.cafe.wrapper.ProductWrapper(p.id, p.name, p.description, p.price, p.status, p.category.id, p.category.name) from Product p")
